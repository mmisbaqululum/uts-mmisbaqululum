...
public class JenisDetailAdapter extends RecyclerView.Adapter<JenisDetailAdapter.ViewHolder> {

    private Context context;
    private List<Karawitan> items;

    public JenisDetailAdapter(Context context, List<Karawitan> items) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemJenis) {
            super(itemJenis);
            logoImage = itemJenis.findViewById(R.id.image_logo_detail);
            nameText = itemJenis.findViewById(R.id.text_name_detail);
